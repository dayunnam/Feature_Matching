...
namespace {
    ...
    const char* keys =
        ...
        "{help h ?       |       | Usage examples1:  --b=../dataset/Image_B07.tif --t=../dataset/Image_B01.tif  --o=../dataset --s=1\n}";
}
//--b=../dataset/sea_test0.jpg --t=../dataset/sea_test1.jpg -o=../dataset -s=0
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "\tCorrect match rate : " << static_cast<float>(inlier_num)/ static_cast<float>(matches.size()) << "%"<<  std::endl;
